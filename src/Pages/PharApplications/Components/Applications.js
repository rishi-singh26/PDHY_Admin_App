    ...
    firestore
      ...
      .onSnapshot(
        ...
        (err) => {
          ...
          setIsLoading(false);
          console.log(
            "Error in getting pharmacy application with id ",
            id,
            err.message
          );
        }
    ...
    if (application.statusId == 0) {
      dispatch(
        showAlert(
          ...
          () =>
            changeAppliStatus(application._id, 1, "Processing", () =>
              props.navigation.navigate("PharmacyApplicationDetail", {
                application,
              })
            )
        )
      ...
      props.navigation.navigate("PharmacyApplicationDetail", { application });
